...
![](images/pic2.png)<br />该图叫做经验累积分布函数曲线(Empirical cumulative distribution function),简称CDF。  
...
![](images/pic3.png)<br />根据此图，一般选取拐点处的k值作为最佳分类数。  

> The delta area score (y-axis) indicates the relative increase in cluster stability.  

### Tracking Plot  

![](images/pic4.png)<br />这个图从行（k）开始看，展示了不同聚类数(k)下，每个sample(列)都被分为了哪一类。比如，k=2时，样本分为浅蓝色和深蓝色的两类。
