...
+ 计算方法：
    $$RPM=\frac{GeneMappedReads*10^6}{TotalMappedReads}$$
...
+ 计算方法：
    $$TPM=\frac{X_i}{L_i}*(\frac{1}{\sum_{j}{\frac{X_j}{L_j}}})*10^6=\frac{\frac{X_i}{L_i}}{\sum_{j}{\frac{X_j}{L_j}}}*10^6$$
